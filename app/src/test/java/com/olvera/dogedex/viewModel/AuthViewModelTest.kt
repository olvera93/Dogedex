...
class AuthViewModelTest {
        ...
        class FakeAuthRepository : AuthTasks {
            override suspend fun signIn(email: String, password: String): com.olvera.dogedex.core.api.ApiResponseStatus<com.olvera.dogedex.core.model.User> {
                return com.olvera.dogedex.core.api.ApiResponseStatus.Success(
                    com.olvera.dogedex.core.model.User(1, "olvera@gmail.com", "")
                )
            }
            ...
            override suspend fun signUp(
                ...
                return com.olvera.dogedex.core.api.ApiResponseStatus.Success(
                    com.olvera.dogedex.core.model.User(1, "", "")
                )
            }
        }
    ...
    fun testLoginStatesCorrect() {
        ...
        val fakeUser = com.olvera.dogedex.core.model.User(1, "olvera@gmail.com", "")


        class FakeAuthRepository : AuthTasks {
            override suspend fun signIn(email: String, password: String): com.olvera.dogedex.core.api.ApiResponseStatus<com.olvera.dogedex.core.model.User> {
                return com.olvera.dogedex.core.api.ApiResponseStatus.Success(fakeUser)
            }
    ...
    fun testSignUpValidationsCorrect() {
        ...
        class FakeAuthRepository : AuthTasks {
            ...
            override suspend fun signUp(
                ...
                return com.olvera.dogedex.core.api.ApiResponseStatus.Success(
                    com.olvera.dogedex.core.model.User(1, "olvera@gmail.com", "32iuir")
                )
    ...
    fun testSignUpStatesCorrect() {
        ...
        class FakeAuthRepository : AuthTasks {
            override suspend fun signIn(email: String, password: String): com.olvera.dogedex.core.api.ApiResponseStatus<com.olvera.dogedex.core.model.User> {
                return com.olvera.dogedex.core.api.ApiResponseStatus.Success(
                    com.olvera.dogedex.core.model.User(
                        1,
                        "",
                        ""
                    )
